...
- **`ns2/diffserv4ns/examples/example-3/`** — thesis Scenario 3 (§4.3, 771 nodes, 5-class Olympic + VoIP service model, LLQ scheduler). See `docs/superpowers/plans/2026-04-16-fullscale-scenario3-reconstruction.md` for the original reconstruction record and the SVN-discovery diff.
...
If a publication comes out of the port (Phase 7 in `PHASE_PLAN.md`), the lineage gives it a distinctive framing:
