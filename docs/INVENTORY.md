# DiffServ4NS — Inventory and Analysis
...
**Licence:** GPLv2
**Target platform:** ns-2 version 2.29
...
## 6. Three independent validation oracles
...
3. **example-1 simulation outputs** — running the original ns-2 module on the example produces gnuplot traces (queue length, OWD, IPDV) that any reimplementation should reproduce within statistical tolerance.
